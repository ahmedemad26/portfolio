...
<div align="center">
  ...
  ·
  <a href="https://github.com/ahmedemad26/portfolio/pulls">Request Feature</a>
</div>
...
```text
├── app/
│   ├── _components/     # Modular UI Sections (Hero, Projects, Contact, etc.)
│   ├── layout.tsx       # Global layouts & Meta tags
│   └── page.tsx         # Main entry point
├── public/
│   └── assets/          # High-quality project screenshots & icons
